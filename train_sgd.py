...
plt.title('Loss Vs Epoch (GradientDescent optimizer)')
#plt.show();
plt.savefig('GradientDescent_cross_loss.jpg')
...
plt.xlabel('Epoch')
plt.ylabel('Acc')
plt.title('Acc Vs Epoch (GradientDescent optimizer)')
plt.savefig('GradientDescent_acc.jpg')
#plt.show(); 
